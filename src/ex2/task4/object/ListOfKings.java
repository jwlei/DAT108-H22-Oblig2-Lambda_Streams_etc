...
public class ListOfKings {
	...
	public static List<King> norwegian;
	
	static {
		norwegian = new ArrayList<>();
		
		norwegian.add(new King("Christian I",		1426, 1448, 1482,
		...
		norwegian.add(new King("Hans",			1455, 1482, 1513,
		...
		norwegian.add(new King("Christian II",	1481, 1513, 1523,
				IMG_ROOT + "0/09/ChristianIIb.jpg/100px-ChristianIIb.jpg"));
		norwegian.add(new King("Frederik I",		1471, 1523, 1535,
				IMG_ROOT + "2/2c/Frederik1dk.jpg/100px-Frederik1dk.jpg"));
		norwegian.add(new King("Christian III",	1503, 1535, 1559,
				IMG_ROOT + "b/b8/Christian_III_of_Denmark.jpg/100px-Christian_III_of_Denmark.jpg"));
		norwegian.add(new King("Frederik II",		1534, 1559,	1588,
